...
public class RewardServiceTest {
    ...
    public void testGetRewardByCustomerId() {
        Transaction t1 = new Transaction(1, new Random().nextInt(100000000), LocalDateTime.of(2023, 2, 10, 1, 45), 80);
        Transaction t2 = new Transaction(1, new Random().nextInt(100000000), LocalDateTime.of(2023, 1, 10, 1, 45), 54);
        Transaction t3 = new Transaction(1, new Random().nextInt(100000000), LocalDateTime.of(2022, 12, 10, 1, 45), 117);
        Transaction t4 = new Transaction(1, new Random().nextInt(100000000), LocalDateTime.of(2022, 11, 10, 1, 45), 98);
    ...
    public void testGetRewards() {
        ...
        Transaction t5 = new Transaction(2, new Random().nextInt(100000000), LocalDateTime.of(2023, 2, 10, 1, 45), 70);
        Transaction t6 = new Transaction(2, new Random().nextInt(100000000), LocalDateTime.of(2023, 1, 10, 1, 45), 94);
        Transaction t7 = new Transaction(2, new Random().nextInt(100000000), LocalDateTime.of(2022, 12, 10, 1, 45), 177);
        Transaction t8 = new Transaction(2, new Random().nextInt(100000000), LocalDateTime.of(2022, 11, 10, 1, 45), 68);
